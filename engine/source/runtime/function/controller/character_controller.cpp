...
namespace Pilot
{
    ...
    Vector3 CharacterController::move(const Vector3& current_position, const Vector3& displacement)
    {
        ...
        //    final_position += hits[0].hit_distance * horizontal_direction;
            ...
            Vector3 desired_direction = Vector3::lerp(horizontal_direction.project(hits[0].hit_normal), horizontal_direction.reflect(hits[0].hit_normal), elastic_ratio);
            desired_direction.normalise();
            Vector3 desired_displacement = horizontal_displacement.length() * desired_direction;
